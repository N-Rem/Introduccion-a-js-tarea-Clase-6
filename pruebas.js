...
function pruebaValidarInputTrabajo (){
    console.assert(validarInputTrabajo("asdjf")==="", "validarInputTrabajo no valido correctamente el valor del input Radio.");
    console.assert(validarInputTrabajo("") === "hay valores no chequeados", "validarInputTrabajo no valido un valor vacio.");
}
function pruebaValidarSalarioAnual (){
    console.assert(validarSalarioAnula (150000) === "", "validarSalarioAnual no valido un valor correcto.");
    console.assert(validarSalarioAnula(0) === "debe ingresar un salario anual.", "validarSalarioAnual no valido un valor vacio");
}
